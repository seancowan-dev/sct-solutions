...
//      2. Please be aware this is only for what you pass in the         //
//      inputContent prop this is not a comprehensive list of            //
//      configurations available for each input                          //
//                                                                       //
//      i. onClick handlers are not considered 'content' while           // 
//      input states like being the active element, checked, or          // 
//      required are considered content because they depend upon         //    
//      content to be determined                                         //
//                                                                       //
//      ii. this is why inputs like button, image, or submit             //
//        take minimal 'content' properties                              //
//                                                                       //
//                                                                       //
//------/button/---------------------------------------------------------//
...
//      \data model\                                                     //         
//      let email = {                                                    //
//          pattern:"^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.   //
//                    [0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))               //
//                        ([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$",             //
